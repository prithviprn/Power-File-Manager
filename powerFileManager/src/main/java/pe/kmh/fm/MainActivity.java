    ...
    public class FileAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            if (internal_icon[position] > 0)
                holder.fileicon.setImageResource(internal_icon[position]);
                ...
                if (internal_icon[position] == Apk) {
                    if (isScrolling) holder.fileicon.setImageResource(R.drawable.android);
                        ...
                        loader.DisplayImage(object.get(position).getName(), dir, holder.fileicon, position);
            ...
            if (isSelected[position] == View.VISIBLE) holder.check.setVisibility(View.VISIBLE);
            else if (isSelected[position] == View.INVISIBLE)
                holder.check.setVisibility(View.INVISIBLE);
            else if (isSelected[position] == View.GONE) holder.check.setVisibility(View.GONE);
            return convertView;
        }
